...
if __name__ == "__main__":
    with DriverManager() as driver:
        ...
        df.to_csv('./files/stonebridge/39887f7b-febf-4241-9100-994bb004bbfd_expedia_reviews.csv', index=False)
        print(f"Saved {len(review_data)} reviews to ./files/stonebridge/39887f7b-febf-4241-9100-994bb004bbfd_expedia_reviews.csv")