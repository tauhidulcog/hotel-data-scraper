...
if __name__ == "__main__":
    with DriverManager() as driver:
        hotel_url = 'https://www.expedia.com/Denver-Hotels-The-Slate-Denver.h70260068.Hotel-Information'
        ...
        df.to_csv('./files/stonebridge/c7868d73-5434-4c22-8c4c-2cc2d424aa7e_expedia_reviews.csv', index=False)
        print(f"Saved {len(review_data)} reviews to ./files/stonebridge/DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD_expedia_reviews.csv")